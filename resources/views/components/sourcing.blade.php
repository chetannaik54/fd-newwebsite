        ...
        <div class="row">
            <div class="col-xxl-12">
                <div class="testimonial__sec-title text-anim">
                    <h3 class="sec-title-6 title-anim">Employee feedback</h3>
                    <p>With over 300+ reviews from our employees</p>
                </div>
            </div>
            <div class="swiper testimonial__slider-4">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide testimonial__slide-4">
                        <img class="testimonial__img-4" src="https://ui-avatars.com/api/?name=Pradeep+Raghavendra" alt="Testimonial Image">
                        <div class="testimonial__info-4">
                    ...
                    <div class="swiper-slide testimonial__slide-4">
                        <img class="testimonial__img-4" src="https://ui-avatars.com/api/?name=Alisondefnal+Dsouza" alt="Testimonial Image">
                        <div class="testimonial__info-4">
