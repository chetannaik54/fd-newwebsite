            ...
            <div class="row">
              <div class="col-xxl-12">
                <div class="hero__content animation__hero_one">
                  <a href="{{ route('solutions') }}">Strategy, Design, Solution Development <span><i class="fa-solid fa-arrow-right"></i></span></a>
              ...
              <div class="row">
                ...
                <div class="col-xxl-5 col-xl-5 col-lg-5 col-md-5">
                  <div class="service__top-text text-anim">
                    <p>We bring improved and <span>absurdly affordable solutions</span> to build businesses future ready.</p>
                  </div>
                </div>
                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3">
                  <div class="service__top-btn">
                    <div class="btn_wrapper">
                      <a href="{{ route('solutions') }}" class="btn-item wc-btn-secondary btn-hover"><span></span> View <br>all
                    ...
                    <div class="service__list">
                        ...
                        <div class="service__item animation_home1_service" data-service="1">
                          ...
                          <div class="service__text">
                            <p>Fidelis Group security services includes real time risk management, secure process
                              implementations, brand reputation management, threat mapping and mitigation.</p>
                          </div>
                        ...
                        <div class="service__item  animation_home1_service" data-service="2">
                          ...
                          <div class="service__text">
                            <p>Fidelis Group provides 24X7 coverage,
                              custom coverage, tiered support levels, administration, troubleshooting, alerts
                      ...
                      <a href="{{ route('solutions') }}">
                        <div class="service__item  animation_home1_service" data-service="3">
                          ...
                          <div class="service__text">
                            <p>We strategically implement <strong>affordable customised consultancy</strong> and solutions to engage and
                              align the right process and resources to meet specific demands.</p>
                          </div>
                          <div class="service__link">
                            <p><i class="fa-solid fa-arrow-right"></i></p>
                          </div>
              ...
              <div class="col-xxl-12">
                ...
                <div class="about__content-wrapper">
                  ...
                  <div class="about__content text-anim">
                    <p>At Fidelis Group, our IT Infrastructure Management Services are designed to reinvent and
                      change enterprises by using transformational and digital-ready IT infrastructure and
                      proactively leveraging next-generation technology, information, and data. We offer systems</p>
                    
                    <p>management, virtual and remote assets management, maintenance and upgrades, data
                      center solutions, native cloud solutions, security, integrations and management,
                      applications and network solutions.</p>

                    <div class="cursor-btn btn_wrapper">
                      <a class="btn-item wc-btn-primary btn-hover" href="{{ route('about-us') }}"><span></span> Explore Us <i
                ...
                <div class="swiper workflow__slider ">
                  <div class="swiper-wrapper">
                    <div class="swiper-slide workflow__slide fade_left">
                      ...
                      <p>We determine who our target audience is by market research, industry trends, competitors etc.</p>
                    </div>
                    ...
                    <div class="swiper-slide workflow__slide fade_left">
                      ...
                      <p>We develop roadmaps, platform &amp; strategy for implementation of RPA processes, managing
                        pitfalls etc.</p>
                    </div>
                    ...
                    <div class="swiper-slide workflow__slide fade_left">
                      ...
                      <p>We provide customized solutions for different sectors like Human Resources, Banking and
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide testimonial__slide-4">
            ...
            <div class="testimonial__info-4">
              ...
              <p>Joined Fidelis a year back. Was working in a different background the management gave me an opportunity to start & learn something new. The management here follows an open door policy hence they are easily accessible.
                A very supportive manager and a team who is always there to help you out.</p>
          ...
          <div class="swiper-slide testimonial__slide-4">
            ...
            <div class="testimonial__info-4">
              ...
              <p>Working in Fidelis Technology services pvt ltd more than one year .Very good management and on Time salary.They do employees engagement activities for WFH Employees as well . always feel connected with company.
                Flexible timings ,Good Work Life Balance and No work Pressure.happy to work with fidelis</p>
